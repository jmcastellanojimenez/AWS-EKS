# Configuration for EKS Platform Workflows
...
workflow_dependencies = "Sequential: Foundation → Ingress → Others"

# Naming conventions
workflow_naming = "🏗️ Workflow X: Component Name"
...
traffic_flow = "Internet → Cloudflare → AWS NLB → Ambassador → Services"
